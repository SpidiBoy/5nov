 ...
 * @author LENOVO
 */
public class PantallaGameOver extends EstadoJuegoBase {
    ...
    public PantallaGameOver(GestorEstados gestorEstados, Mariotest juego) {
    ...
    public void render(Graphics g) {
        ...
        int yTitulo = 150;
        g.drawString(titulo, (Mariotest.getVentanaWidth() - anchoTitulo) / 2, yTitulo);
        
        // Sombra del título
        g.setColor(new Color(0, 0, 0, alphaInt / 2));
        g.drawString(titulo, 
                    (Mariotest.getVentanaWidth() - anchoTitulo) / 2 + 3, 
                    yTitulo + 3);
        ...
        for (String stat : stats) {
            ...
            g.drawString(stat, (Mariotest.getVentanaWidth() - anchoStat) / 2, y);
            y += espaciado;
        }
        ...
        if (ticksAnimacion > 120) { // Mostrar después de 2 segundos
            ...
            if (ticksAnimacion % 60 < 30) {
                ...
                g.drawString(reintentar, 
                            (Mariotest.getVentanaWidth() - anchoR) / 2, 
                            y + 80);
            }
            ...
            g.drawString(menu, 
                        (Mariotest.getVentanaWidth() - anchoM) / 2, 
                        y + 120);
        }
    }
    ...
    public void keyPressed(KeyEvent e) {
        ...
        switch (key) {
            case KeyEvent.VK_ENTER:
                // Reintentar - volver a iniciar el juego

...
public class PantallaControles extends EstadoJuegoBase {
    ...
    public PantallaControles(GestorEstados gestorEstados, Mariotest juego) {
    ...
    public void render(Graphics g) {
        ...
        g.drawString(titulo, (Mariotest.getVentanaWidth() - anchoTitulo) / 2, 80);
        
        // ==================== CONTENIDO ====================
        if (imagenControles != null) {
            // Mostrar imagen de controles centrada
            int x = (Mariotest.getVentanaWidth() - imagenControles.getWidth()) / 2;
            int y = 150;
        ...
        if (ticksAnimacion % 60 < 30) {
            ...
            g.drawString(volver, 
                        (Mariotest.getVentanaWidth() - anchoVolver) / 2, 
                        Mariotest.getVentanaHeight() - 50);
        }
    }
